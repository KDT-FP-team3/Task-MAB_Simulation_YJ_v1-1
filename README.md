...
![각 슬롯머신의 보상 분포](./fig1_reward_distribution.png)
...
![핵심 개념 요약](./fig6_concept_summary.png)
...
![전략별 누적 보상 비교](./fig2_cumulative_reward.png)
...
![전략별 머신 선택 비율](./fig3_selection_ratio.png)
...
![최적 머신 선택률 변화](./fig4_optimal_selection.png)
...
![ε 값 비교](./fig5_epsilon_comparison.png)
